...
shared_examples 'default share' do
  ...
  it {
    is_expected.to contain_augeas("#{title}-section").with(
  ...
  it {
    is_expected.to contain_augeas("#{title}-changes").with(
    incl: '/etc/samba/smb.conf',
    lens: 'Samba.lns',
    context: '/files/etc/samba/smb.conf',
    changes: changes,
  ...
  on_supported_os({
    ...
    context "for #{os}" do
      ...
      context 'with base options' do
        ...
        it {
          is_expected.to contain_augeas('test_share-section').with(
          incl: '/etc/samba/smb.conf',
          lens: 'Samba.lns',
          context: '/files/etc/samba/smb.conf',
        ...
        it {
          is_expected.to contain_augeas('test_share-changes').with(
          incl: '/etc/samba/smb.conf',
          lens: 'Samba.lns',
          context: '/files/etc/samba/smb.conf',
          require: 'Augeas[test_share-section]',
